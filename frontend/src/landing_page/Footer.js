    ...
    return (
        <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className='container border-top mt-5' >
                <div className='row mt-5'>
                    <div className='col'>
                        ...
                        />
                        <p>
                            &Compy; 2010 - 2024, Not Zerodha Broking Ltd , All rights reserved
                        </p>
                    </div>
                    <div className='col'>
                        <p>Company</p>
                        ...
                        <a href='' className='text-muted' style={{ textDecoration: "none" }}>Press & mediaZerodha cares (CSR)</a>
                    </div>
                    <div className='col'>
                        <p>Support</p>
            ...
            <div className='text-center mt-3' >
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>NSE</a>
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>MCX</a>
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>Terms & conditions</a>
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>Policies & procedures</a>
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>Privacy policy</a>
                <a href='' className='p-5 text-muted' style={{ textDecoration: "none" }}>Disclosure</a>
            </div>
        </footer>
    );
}
